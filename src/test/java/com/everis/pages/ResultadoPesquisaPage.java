...
public class ResultadoPesquisaPage extends BasePage {
	...
	public void adicionarProdutoAoCarrinho(String nomeProduto) {
		WebElement nomeProdutoTela = driver.findElement(
		By.xpath(".//*[@itemprop='name']/*[contains(text(), '" +
		 nomeProduto + 
		 "')] | .//*[@itemprop='name'][text()='" + 
		 nomeProduto + "']"));
	...
	public void acessarProduto(String nomeProduto) {
		WebElement tituloProduto = driver.findElement(
				By.xpath("//*[@class='product-name'][@title='"+nomeProduto+"']"));
		tituloProduto.click();
